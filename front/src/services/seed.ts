...
export const requests: Request[] = [
  {
    ...
    client: clients[0]!,
    status: 'pendente',
    approvedAt: new Date('2025-09-10T09:15:00'),
  },
  {
    id: 2,
    client: clients[1]!,
    status: 'aprovado',
    approvedAt: new Date('2025-09-12T14:30:00'),
  },
  {
    id: 3,
    client: clients[2]!,
    status: 'aprovado',
    rejectReason: 'Renda insuficiente para o limite solicitado',
    approvedAt: new Date('2025-09-14T09:10:00'),
  },
  {
    id: 4,
    client: clients[3]!,
    status: 'aprovado',
    approvedAt: new Date('2025-09-15T16:00:00'),
  },
  {
    id: 5,
    client: clients[4]!,
    status: 'pendente',
    approvedAt: new Date('2025-09-16T13:05:00'),
  },
  {
    id: 6,
    client: {
